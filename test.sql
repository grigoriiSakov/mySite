...
Ну и последнее, что заметим: пользователи – простые люди, поэтому среди предложений можно найти немало тех, а, вернее, даже преобладают те, которые не несут особой практической пользы, но весьма любопытны в эстетическом плане.' );
INSERT INTO `article`(`id_article`,`title`,`content`) VALUES ( '20', 'Opera 39: что нового?', '[img \'http://mysite2.dev/img/art3.png\'alt=\'art3.png\']
[b]Норвежская компания[/b] [a url=\'http://www.opera.ru\'] Opera[/a] готовится представить следующее крупное обновление для своего одноимённого браузера, которое принесёт как одну давно ожидаемую, так и развитие нескольких уже имеющихся в веб-обозревателе функций. О том, что нового появится в Opera 39 мы подробно расскажем в этой заметке.
Безусловно, самая ожидаемая пользователями новинка Opera 39 – это встроенный бесплатный и безлимитный VPN. Opera первые, кто реализует нечто подобное в популярном браузере, что называется, прямо из коробки. VPN – это анонимность, безопасность и возможность обходить запреты самого разного уровня. За всё это, впрочем, придётся расплатиться некоторым понижением производительности на время VPN-сёрфинга.[end]
...
Эти и прочие новые функции разработчики покажут уже в другой версии, которая появится после Opera 39.' );
-- ---------------------------------------------------------
...
-- Dump data of "user" -------------------------------------
INSERT INTO `user`(`id_user`,`user_login`,`user_name`,`user_pass_hash`,`user_session`,`user_action_hash`,`is_active`,`user_last_action`,`email`) VALUES ( '1', 'test', 'test', '202cb962ac59075b964b07152d234b70', 'c17edni7s93c6mkb0bj7334ou2', 'af9bb5e423fd554fd312c589fc7079f5', '1', '1470220989', '' );
...
INSERT INTO `user`(`id_user`,`user_login`,`user_name`,`user_pass_hash`,`user_session`,`user_action_hash`,`is_active`,`user_last_action`,`email`) VALUES ( '11', 'test1', 'test1', '202cb962ac59075b964b07152d234b70', 'daf1vgcmn5638vlq2bjbi6r4s6', 'e27e40e28c6fee82aa3bd384f3a10573', '0', '1469788947', 'test1@mail.ru' );
-- ---------------------------------------------------------
...
INSERT INTO `user_role`(`id_user_role`,`id_user`,`id_role`) VALUES ( '11', '9', '2' );
INSERT INTO `user_role`(`id_user_role`,`id_user`,`id_role`) VALUES ( '12', '10', '2' );
INSERT INTO `user_role`(`id_user_role`,`id_user`,`id_role`) VALUES ( '13', '11', '2' );
-- ---------------------------------------------------------
